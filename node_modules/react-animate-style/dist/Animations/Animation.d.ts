...
declare const Animation: ({ animationIn, animationOut, animationInDelay, animationOutDelay, animationInDuration, animationOutDuration, isVisible, style, className, children, ref }: Props) => JSX.Element;
